...
if (isset($_GET['category_id'])) {
  $colname_Recordset1 = $_GET['category_id'];
}
mysql_select_db($database_eventuality, $eventuality);
$query_Recordset1 = sprintf("SELECT user_table.user_id,event_id, event_title, DAYNAME(date_added) as day, MONTHNAME(date_added) as month, DAY(date_added) as date, YEAR(date_added) as year, `description` FROM events_table, user_table WHERE user_table.user_id=events_table.user_id AND category_id = %s ORDER BY date_added ASC", GetSQLValueString($colname_Recordset1, "int"));
...
<div id="MMMenu1124001401_0" onmouseout="MM_menuStartTimeout(1);" onmouseover="MM_menuResetTimeout();"><a href="catevent.php? category_id=1" id="MMMenu1124001401_0_Item_0" class="MMMIFVStyleMMMenu1124001401_0" onmouseover="MM_menuOverMenuItem('MMMenu1124001401_0');">Sports/Walks/Fitness</a><a href="catevent.php? category_id=2" id="MMMenu1124001401_0_Item_1" class="MMMIVStyleMMMenu1124001401_0" onmouseover="MM_menuOverMenuItem('MMMenu1124001401_0');">Festivals&nbsp;&amp;&nbsp;Fairs</a><a href="catevent.php? category_id=3" id="MMMenu1124001401_0_Item_2" class="MMMIVStyleMMMenu1124001401_0" onmouseover="MM_menuOverMenuItem('MMMenu1124001401_0');">Performing&nbsp;Arts</a><a href="catevent.php? category_id=4" id="MMMenu1124001401_0_Item_3" class="MMMIVStyleMMMenu1124001401_0" onmouseover="MM_menuOverMenuItem('MMMenu1124001401_0');">Nightlife</a></div>    </div>
  ...
  if($_GET['category_id']==1){
	  echo "<h1>Sports/Walk/Fitness Events</h1>" ;
	  echo "<hr />";
	  }
	  elseif($_GET['category_id']==2){
		  echo "<h1>Festivals & Fairs Events</h1>" ;
	  	  echo "<hr />";	
	  	}
		elseif($_GET['category_id']==3){
			echo "<h1>Performing Arts Events</h1>";
			echo "<hr />";
			}
			else{
				echo "<h1>Nightlife Events</h1>";
				echo "<hr />";
				}
				?>
...
<table border="1">
  ...
  <?php do { ?>
    <tr>
      <td><p>
        <input type="radio" name="event_id" id="event_id" value="<?php echo $row_Recordset1['event_id']; ?>" />
        </p>
        <p><?php echo $row_Recordset1['user_id']; ?><br />
          <?php echo $row_Recordset1['day'].", ". $row_Recordset1['month']." ".$row_Recordset1['date'].", ".$row_Recordset1['year'];?></p></td>
      <td><?php echo $row_Recordset1['event_title']; ?><br />
<p>          <img src= "event_images/<?php echo $row_Recordset1['event_images']; ?>" width="150" height="150" /></p></td>
