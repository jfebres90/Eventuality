...
$query_Recordset1 = sprintf("SELECT comment_id,comment_title,comment_txt, DAYNAME(date_posted) as day, MONTHNAME(date_posted) as month, DAY(date_posted) as date, YEAR(date_posted) as year, event_title FROM comments_table, events_table WHERE comments_table.user_id = %s AND events_table.event_id = comments_table.event_id ORDER BY date_posted DESC", GetSQLValueString($colname_Recordset1, "text"));
...
<form id="form1" name="form1" method="post" action="update_comment.php">
  <table border="1">
    <tr>
      <td width="248">Comment</td>
      </tr>
    <?php do { ?>
      <tr>
        <td height="107"><p>
          <input type="radio" name="comment_id" id="comment_id" value="<?php echo $row_Recordset1['comment_id']; ?>" />
          </p>
          <p> <?php echo $row_Recordset1['event_title']; ?><br />
	Title:<?php echo $row_Recordset1['comment_title']; ?><br />
            Comment: <?php echo $row_Recordset1['comment_txt']; ?><br />
            Posted: <?php echo $row_Recordset1['day'].", ". $row_Recordset1['month']." ".$row_Recordset1['date'].", ".$row_Recordset1['year'];?></p></td>
        </tr>
