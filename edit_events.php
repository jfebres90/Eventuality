...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE events_table SET event_title=%s, `description`=%s WHERE event_id=%s",
...
mysql_select_db($database_eventuality, $eventuality);
$query_Recordset1 = sprintf("SELECT event_id, event_title, `description` FROM events_table WHERE event_id = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="left">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Event_id:</td>
      <td><?php echo $row_Recordset1['event_id']; ?></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Event_title:</td>
      <td><input type="text" name="event_title" value="<?php echo htmlentities($row_Recordset1['event_title'], ENT_COMPAT, 'UTF-8'); ?>" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">Description:</td>
      <td><textarea name="description" cols="32" rows="7"><?php echo htmlentities($row_Recordset1['description'], ENT_COMPAT, 'UTF-8'); ?></textarea></td>
    </tr>
    <tr valign="baseline">
  ...
  <p>
    ...
    <input type="hidden" name="event_id" value="<?php echo $row_Recordset1['event_id']; ?>" />
  </p>
</form>
